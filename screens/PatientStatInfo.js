...
export default function PatientStatInfo({route}){
    console.log(route)
            ...
            <ScrollView>
              <View style={styles.buttonBox}> 
                  ...
                  <View style={styles.buttonRow}>
                      <TouchableOpacity onPress={() => navigation.navigate("PatientECGScreen", {userID: uID})} style={[styles.button, {backgroundColor: '#f87c7c'}]}>
                          <Text style={styles.buttonText}>Electrocardiogram</Text>
                          <Fontisto style={styles.icon} name={'heartbeat'} size={30} color={'black'}/> 
                      </TouchableOpacity>
                  </View>
                  <View style={styles.buttonRow}>
                      <TouchableOpacity onPress={() => navigation.navigate("PatientThoracicImpedanceScreen", {userID: uID})} style={[styles.button, {backgroundColor: '#f85353'}]}>
                          <Text style={styles.buttonText}>Thoracic Impedance</Text>
                          <FontAwesome5 style={styles.icon} name={'lungs'} size={30} color={'black'}/> 
                      </TouchableOpacity>
                  </View>
                  <View style={styles.buttonRow}>
                      <TouchableOpacity onPress={() => navigation.navigate("PatientMovementScreen", {userID: uID})} style={[styles.button, {backgroundColor: '#e62e2e'}]}>
                          <Text style={styles.buttonText}>Movement</Text>
                          <FontAwesome5 style={styles.icon} name={'running'} size={35} color={'black'}/> 
                      </TouchableOpacity>
                  </View>
                  <View style={styles.buttonRow}>
                      <TouchableOpacity onPress={() => navigation.navigate("PatientHeartRateScreen", {userID: uID})} style={[styles.button, {backgroundColor: '#971313'}]}>
